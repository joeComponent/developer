	...
	return (
		<div className="App">
			...
			<nav class="navbar navbar-expand-md bg-dark navbar-dark">
				<a class="navbar-brand d-block d-md-none" href="#">WebSiteName</a>
			...
			<div id="accordion">
				<div class="card bg-white border-dark mb-3 my-3">
					<div id="form0" class="card-header bg-info text-white" data-toggle="collapse" data-target=".form0-collapse"
						...
						<h3 class="card-subtitle">Image Files</h3>
					</div>
					<div id="form0Div" class="collapse form0-collapse" data-parent='#accordion'>
				...
				<div class="card bg-white border-dark mb-3">
					<div id="form1" class="card-header bg-info text-white" data-toggle="collapse" data-target=".form1-collapse"
						aria-expanded="false" aria-controls="form1Div">
						<h2 class="card-title">Design</h2>
						<h3 class="card-subtitle">Image Files</h3>
					</div>
					<div id="form1Div" class="collapse form1-collapse" data-parent='#accordion'>
						<div className="card-body">
							<div className="row">
				...
				<div class="card bg-white border-dark mb-3">
					<div id="form2" class="card-header bg-info text-white" data-toggle="collapse" data-target=".form2-collapse"
						aria-expanded="false" aria-controls="form2Div">
						<h2 class="card-title">Organization</h2>
						<h3 class="card-subtitle">Image Files</h3>
					</div>
					<div id="form2Div" class="collapse form2-collapse" data-parent='#accordion'>
				...
				<div class="card bg-white border-dark mb-3">
					...
					<div id="form4Div" class="collapse form4-collapse" data-parent='#accordion'>
						<div className="card-body">
							<div className="row">
	...
	render() {
		return (
			<label>Education Type
				<select id="form2FldId" class="form-control-sm ml-3" value={this.state.value} onChange={this.handleChange}>
					<option value="allT" selected>All Types</option>
